              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="suppliers.php" style="float: right; margin-top: -40px;" type="button" class="btn btn btn-light btn-fw"><i class="mdi mdi-keyboard-backspace"></i> Back to Supplier list</a>
                    <form class="form-sample" method="POST" action="common_script.php">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="company_fname" required placeholder="Company FName">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="company_lname" required  placeholder="Company LName">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <hr>
                      <input type="submit" name="add_supplier" class="btn btn-primary mr-2" value="Add supplier">
